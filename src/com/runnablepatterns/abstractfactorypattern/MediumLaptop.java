...
public class MediumLaptop extends Laptop {
	 ...
	 */
	public MediumLaptop(String _name, LaptopPartFactory _partFactory) {
		super(_name);
	...
	public String getDescription() {
		System.out.println(String.format("[Log] getting medium laptop description for: %s Laptop", this.getName()));
		return String.format("%s: Base Medium Laptop", this.getName());
	}
	
	@Override
	public void assemblyParts() {
		System.out.println(String.format("[Log] starting part assembly for Medium Laptop: %s", this.getName()));
